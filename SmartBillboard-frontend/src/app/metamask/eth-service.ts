...
export class EthService {
    ...
    async getX(){
        ...
        var contract = new this.web3js.eth.Contract(abi, "0xeC4a4f30b59e1C3370E8963Afe9c6357d644d91B".toLowerCase());
        console.log(contract);
        var x = await contract.methods.getAd(1).send({ from:this.account});
        console.log(x);
    }
